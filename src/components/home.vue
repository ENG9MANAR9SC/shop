    ...
    <div class="">
        <div class="c-container relative">
            ...
            <div class="bg-black rounded-tl-lg rounded-tr-[60px] rounded-b-lg"> 
                <img class="w-full lg:h-72 sm:h-36 object-cover rounded-tl-lg rounded-tr-[60px] rounded-b-lg opacity-50 " src="/icons/drinks/drink1.png" >
            </div>
            ...
            <div class="c-container">
                 ...
                 <div class="flex flex-wrap justify-between">
                    <div v-for="service in services" class="responsive">
                        <service :key="service.title" :title="service.title" :description="service.description" :image="service.image" class="mx-2"/>
                    </div>
                </div>
           </div> 
        </div>
