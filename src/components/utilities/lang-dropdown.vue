<template>
  <div class="relative z-10">
    <button class="flex items-center space-x-2 gap-3 px-2 py-[2px] rounded-md text-secondery hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
      @click="isOpen = !isOpen">
      <img :src="languageIcons[activeLanguage].icon" :alt="languageIcons[activeLanguage].name" class="h-5 w-5 gap-2" />
